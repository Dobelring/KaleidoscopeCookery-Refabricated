...
public class DecorationRecipeProvider extends ModRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput consumer) {
        ...
        addCookStool(ModItems.COOK_STOOL_POPLAR, Blocks.POPLAR_PLANKS).save(consumer);
        ...
        addTable(ModItems.CHAIR_POPLAR, Blocks.POPLAR_FENCE, Blocks.POPLAR_SLAB).save(consumer);
        ...
        addTable(ModItems.TABLE_POPLAR, Blocks.POPLAR_FENCE, Blocks.POPLAR_SLAB).save(consumer);
    }

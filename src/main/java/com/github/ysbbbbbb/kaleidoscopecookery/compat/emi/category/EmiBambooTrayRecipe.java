...
public class EmiBambooTrayRecipe extends BasicEmiRecipe {
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(
            ...
            EmiIngredient.of(Ingredient.of(ModItems.BAMBOO_TRAY))
    );
    ...
    public static void register(EmiRegistry registry) {
        ...
        registry.addWorkstation(CATEGORY, EmiStack.of(ModItems.BAMBOO_TRAY));
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addSlot(inputs.getFirst(), 41, 27)
                .drawBack(false);
        widgets.addSlot(outputs.getFirst(), 131, 29)
                .drawBack(false)
                .recipeContext(this);

...
public class BambooTrayRecipeCategory implements IRecipeCategory<BambooTrayRecipe> {
    ...
    public BambooTrayRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.iconDraw = guiHelper.createDrawableItemLike(ModItems.BAMBOO_TRAY);
    }
    ...
    @Override
    public void draw(BambooTrayRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphics guiGraphics, double mouseX, double mouseY) {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, BambooTrayRecipe recipe, @NotNull IFocusGroup focuses) {
    ...
    @Override
    public @NotNull RecipeType<BambooTrayRecipe> getRecipeType() {
        return TYPE;
    }
